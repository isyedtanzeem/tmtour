...
import { HolidayPackage, VisaService, BookingInquiry, VisaApplication, GoogleSheetsConfig, ItineraryDay } from '../types';
...
export const AdminPortal: React.FC<AdminPortalProps> = ({
  ...
  const [adminTab, setAdminTab] = useState<'packages' | 'visas' | 'bookings' | 'sheets' | 'logo'>('packages');
    ...
    <div className="py-8 px-4 sm:px-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold bg-blue-500/20 text-blue-300 border border-blue-400/30 mb-3">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-1 max-w-2xl">
              All holiday packages, visa offerings, and client inquiries are managed here and synced securely with your travel database.
            </p>
          </div>
